...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      admin_remove_photo: {
        Args: { p_index: number; p_user: string };
        Returns: undefined;
      };
      admin_set_ban: {
      ...
      can_send_message: {
        Args: { p_match_id: string; p_sender: string };
        Returns: boolean;
      };
      ...
      is_matched: { Args: { a: string; b: string }; Returns: boolean };
    ...
    Enums: {
      ...
      looking_for: "female" | "male" | "nonbinary" | "everyone";
